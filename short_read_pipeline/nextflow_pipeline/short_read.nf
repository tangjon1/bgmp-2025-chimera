...
process bbmerge{
    //bbtools environment goes below
    ...
    publishDir "/projects/bgmp/shared/groups/2025/chimera/mlscha/bgmp-2025-chimera-fixed/012026_fullNextSeq_newBBtools/01-bbmerge/", mode: 'copy' 

    script:
    // update the path for bbtools bbmerge.sh script below
    // update the desired output locations and names in out1, out2, and ihist
    """
    ...
    outu1=/projects/bgmp/shared/groups/2025/chimera/mlscha/bgmp-2025-chimera-fixed/012026_fullNextSeq_newBBtools/01-bbmerge/${sampleId}_R1.unmerged.fastq.gz \
    outu2=/projects/bgmp/shared/groups/2025/chimera/mlscha/bgmp-2025-chimera-fixed/012026_fullNextSeq_newBBtools/01-bbmerge/${sampleId}_R2.unmerged.fastq.gz\
    ihist=/projects/bgmp/shared/groups/2025/chimera/mlscha/bgmp-2025-chimera-fixed/012026_fullNextSeq_newBBtools/01-bbmerge/${sampleId}.bbmerge.stats.txt
    """
}

process hts_primers{
    //HTSPrimers environment goes below
    ...
    publishDir "/projects/bgmp/shared/groups/2025/chimera/mlscha/bgmp-2025-chimera-fixed/012026_fullNextSeq_newBBtools/02-hts_primers/", mode: 'copy' 

    script:
    //mkdir -p initializes the directory since just outputting the .stats.txt file is not enough to also make the directory
    //update the directories below to direct the output
    """
    mkdir -p /projects/bgmp/shared/groups/2025/chimera/mlscha/bgmp-2025-chimera-fixed/012026_fullNextSeq_newBBtools/02-hts_primers/
    ...
    -l 5 -x -e 6 -d 6 \
    -L /projects/bgmp/shared/groups/2025/chimera/mlscha/bgmp-2025-chimera-fixed/012026_fullNextSeq_newBBtools/02-hts_primers/${merged_file.simpleName}.flip.stats.txt -F
    """
}
...
process make_barcode_fasta {
    ...
    publishDir "/projects/bgmp/shared/groups/2025/chimera/mlscha/bgmp-2025-chimera-fixed/012026_fullNextSeq_newBBtools/03-make_barcode_fasta/", mode: 'copy'

    script:
    //"24" indicates the expected size of the barcodes that needs to be trimmed
    """
...
process count_barcodes{
    ...
    publishDir "/projects/bgmp/shared/groups/2025/chimera/mlscha/bgmp-2025-chimera-fixed/012026_fullNextSeq_newBBtools/04-count_barcodes/", mode: 'copy'
...
process star_code{
    //Starcode environment goes below
    ...
    publishDir "/projects/bgmp/shared/groups/2025/chimera/mlscha/bgmp-2025-chimera-fixed/012026_fullNextSeq_newBBtools/05-starcode", mode: 'copy'
...
workflow {
    ...
    read_pairs = Channel
        .fromFilePairs('/projects/bgmp/shared/groups/2025/chimera/shared/calin/GC3F_NextSeq_11236/*{R1,R2}_001.fastq.gz')
