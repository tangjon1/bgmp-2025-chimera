...
if (length(args) < 4) {
  stop("Script requires 4 arguments")
}

#####
workingdir = args[1]
dfmapfile = args[2] #"merged.sorted_noN.fasta"
starcodefile = args[3] #"merged.barcodes_collapse_d1.tsv"
fileoutfasta = args[4] #"merged_after_consesnus_R.fasta"
#####
...
ggsave("lengths.png",width=9,height=6)
