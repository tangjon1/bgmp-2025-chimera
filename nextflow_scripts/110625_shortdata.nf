...
process bbmerge{
    ...
    publishDir "/projects/bgmp/shared/groups/2025/chimera/mlscha/bgmp-2025-chimera/110625_shortdata/bbmerge_out/", mode: 'copy' 
    ...
    outu1=/projects/bgmp/shared/groups/2025/chimera/mlscha/bgmp-2025-chimera/110625_shortdata/bbmerge_out/${sampleId}1_unmerged.fastq.gz \
    outu2=/projects/bgmp/shared/groups/2025/chimera/mlscha/bgmp-2025-chimera/110625_shortdata/bbmerge_out/${sampleId}2_unmerged.fastq.gz\
    ihist=/projects/bgmp/shared/groups/2025/chimera/mlscha/bgmp-2025-chimera/110625_shortdata/bbmerge_out/${sampleId}_bbmerge_stats.txt
    """
}
...
process hts_primers{
    ...
    publishDir "/projects/bgmp/shared/groups/2025/chimera/mlscha/bgmp-2025-chimera/110625_shortdata/hts_primers_out/", mode: 'copy' //try move?
    ...
    -l 5 -x -e 6 -d 6 \
    -L /projects/bgmp/shared/groups/2025/chimera/mlscha/bgmp-2025-chimera/110625_shortdata/hts_primers_out/${merged_file.simpleName}_flip_stats.txt -F
    """
}
...
process make_barcode_fasta {
    ...
    publishDir "/projects/bgmp/shared/groups/2025/chimera/mlscha/bgmp-2025-chimera/110625_shortdata/make_barcode_fasta_out/", mode: 'copy'
...
process count_barcodes{
    ...
    publishDir "/projects/bgmp/shared/groups/2025/chimera/mlscha/bgmp-2025-chimera/110625_shortdata/count_barcodes_out/", mode: 'copy'
...
process star_code{
    ...
    publishDir "/projects/bgmp/shared/groups/2025/chimera/mlscha/bgmp-2025-chimera/110625_shortdata/starcode_out", mode: 'copy'
...
workflow {
    ...
    read_pairs = Channel
        .fromFilePairs('/projects/bgmp/shared/groups/2025/chimera/mlscha/BACKUP-110525-bgmp-2025-chimera/ShortIlluminaData/*R{1,2}_001.fastq')
