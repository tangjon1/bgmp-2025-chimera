...
process bbmerge{
    ...
    publishDir "/projects/bgmp/shared/groups/2025/chimera/mlscha/bgmp-2025-chimera/103025_allPairs_outfiles/", mode: 'copy'
    ...
    outu1=/projects/bgmp/shared/groups/2025/chimera/mlscha/bgmp-2025-chimera/103025_allPairs_outfiles/${sampleId}1_unmerged.fastq.gz \
    outu2=/projects/bgmp/shared/groups/2025/chimera/mlscha/bgmp-2025-chimera/103025_allPairs_outfiles/${sampleId}2_unmerged.fastq.gz\
    ihist=/projects/bgmp/shared/groups/2025/chimera/mlscha/bgmp-2025-chimera/103025_allPairs_outfiles/${sampleId}_bbmerge_stats.txt
    """
}
...
process hts_primers{
    ...
    script:
    """
    /usr/bin/time -v hts_Primers -U ${merged_file} -f ${merged_file.simpleName}_flip_trim -P /projects/bgmp/shared/groups/2025/chimera/mlscha/bgmp-2025-chimera/stubby_adapters/HK_ABC-stub_FWD.fasta -Q /projects/bgmp/shared/groups/2025/chimera/mlscha/bgmp-2025-chimera/stubby_adapters/HK_ABC-stub_REV.fasta -l 5 -x -e 6 -d 6 -L /projects/bgmp/shared/groups/2025/chimera/mlscha/bgmp-2025-chimera/103025_allPairs_outfiles/${merged_file.simpleName}_flip_stats.txt -F
    """
}
...
process make_barcode_fasta {
    ...
    | awk 'NR%4 ==2' | cut -c1-24 | awk 'BEGIN{FIELDWIDTHS="20"} {print \$1}' > ${trimmed_file.simpleName}.cut.txt 
    """
}
...
workflow {
    ...
    read_pairs = Channel
        .fromFilePairs('/projects/bgmp/shared/groups/2025/chimera/shared/calin/*_R{1,2}_001.fastq.gz')
